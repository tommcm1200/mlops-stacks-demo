...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops-stacks-demo-run-tests.yml) 
...
* [Staging workspace registered model](https://e2-demo-field-eng.cloud.databricks.com#mlflow/models/staging-mlops-stacks-demo-model)
* [Prod workspace registered model](https://e2-demo-field-eng.cloud.databricks.com#mlflow/models/prod-mlops-stacks-demo-model)
