...
```
mlops-stacks-demo        <- Root directory. Both monorepo and polyrepo are supported.
│
├── mlops_stacks_demo       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
