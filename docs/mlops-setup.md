...
[ML Config](../mlops_stacks_demo/resources/README.md)  guides to make changes to ML code or deployed jobs.
...
Follow the instructions in [mlops-stacks-demo/resources/README.md](../mlops_stacks_demo/resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../mlops_stacks_demo/resources/README.md)  to propose, test, and deploy
